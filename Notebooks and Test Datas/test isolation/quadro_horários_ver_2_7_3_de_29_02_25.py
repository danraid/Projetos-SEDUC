# -*- coding: utf-8 -*-
"""QUADRO_HORÁRIOS_VER_2_7_3 DE_29_02_25.ipynb
...
def calcula_penalidades(horario, demanda):
    ...
    peso_gap_prof = 100         # penalidade para cada gap no horário do professor
...
def score_solucao_com_penalidades(horario, demanda):
    ...
    score = usados - peso_gap_turma * gaps_turma - 5 * nao_aloc - penalidade_soft
    feats = {
        "usados": usados,
        "slots": slots,
        "gaps": gaps_turma,
