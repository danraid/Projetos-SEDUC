# -*- coding: utf-8 -*-
"""QUADRO_HORÁRIOS_VER_2_7_5_3 DE_03_03_25.ipynb
...
# =========================================================================
# 6C) CONSTRUÇÃO HEURÍSTICA + SA #2.7.5.3
# =========================================================================

#2.7.5.3 - Ao invés do GRASP, fazemos construção heurística e depois SA.
hor_inicial, nao_aloc_inicial = constroi_solucao_heuristica(demanda)  #2.7.5.3
score_inicial, feats_inicial = score_solucao_com_penalidades(hor_inicial, demanda)  #2.7.5.3

print("#2.7.5.3 - Resultado inicial do método heurístico:")
print(f"#2.7.5.3 - Score inicial: {score_inicial}")
usados_inicial = conta_alocacoes(hor_inicial)   #2.7.5.3
total_inicial = total_slots_ideal(demanda)      #2.7.5.3
percent_inicial = (usados_inicial / total_inicial) * 100 if total_inicial else 0  #2.7.5.3
print(f"#2.7.5.3 - Slots usados: {usados_inicial}")
print(f"#2.7.5.3 - Slots vazios: {total_inicial - usados_inicial}")
print(f"#2.7.5.3 - Percentual de preenchimento: {percent_inicial:.2f}%")
print("----------------------------------------------")
...
#2.7.5.3 - Chamando SA apenas sobre a solução heurística
hor_final, nao_aloc_final = simulated_annealing(
    hor_inicial, nao_aloc_inicial, demanda, NUM_ITERACOES_SA, T0=100.0, alpha=0.99
)  #2.7.5.3

score_final, feats_final = score_solucao_com_penalidades(hor_final, demanda)  #2.7.5.3

print("Resultado após refinamento com SA:")  #2.7.5.3
print(f"Melhor Score (Heur + SA): {score_final}")  #2.7.5.3
usados_final = conta_alocacoes(hor_final)  #2.7.5.3
total_final = total_slots_ideal(demanda)   #2.7.5.3
percent_filled = (usados_final / total_final) * 100 if total_final else 0  #2.7.5.3
print(f"Slots usados: {usados_final}")  #2.7.5.3
print(f"Slots vazios: {total_final - usados_final}")  #2.7.5.3
print(f"Percentual de preenchimento: {percent_filled:.2f}%")  #2.7.5.3
print("----------------------------------------------")
