# -*- coding: utf-8 -*-
"""QUADRO_HORÁRIOS_VER_2_7_4 DE_29_02_25.ipynb
...
tempos = [1, 2, 3, 4, 5]
NUM_ITERACOES_HEUR = 20000    # número de iterações da busca inicial (GRASP)
NUM_ITERACOES_SA = 20000     # número de iterações do Simulated Annealing (SA)
...
def calcula_penalidades(horario, demanda):
    ...
    peso_gap_prof = 10          # 2.7.4: reduzido de 100 para 50 para penalizar menos gaps no horário do professor
...
def score_solucao_com_penalidades(horario, demanda):
    ...
    # 2.7.4: Aumentado o peso para CH não alocadas de 20 para 50 para incentivar o preenchimento
    score = usados - peso_gap_turma * gaps_turma - 50 * nao_aloc - penalidade_soft   # 2.7.4
    feats = {
        "usados": usados,
        "slots": slots,
        "gaps": gaps_turma,
