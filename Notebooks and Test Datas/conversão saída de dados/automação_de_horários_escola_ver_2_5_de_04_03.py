# -*- coding: utf-8 -*-
"""AUTOMAÇÃO DE HORÁRIOS ESCOLA ver.2.5 de 04.03.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Xwl2f9AoIw8MBybrQFCU6F3FnyF8LyW-
"""
...
#2.5: Preprocessamento para juntar linhas quebradas – agora usando filtered_lines
merged_lines = []  #2.5
for line in filtered_lines:  #2.5
    stripped = line.strip()  #2.5
    if not stripped:
        continue  #2.5
    ...
    if (regex.match(servidor_regex, stripped, flags=regex.IGNORECASE) or
        ...
        merged_lines.append(stripped)  #2.5
    else:
        # Caso contrário, concatena com a última linha adicionada
        if merged_lines:
            merged_lines[-1] = merged_lines[-1] + " " + stripped  #2.5
        else:
            merged_lines.append(stripped)  #2.5

lines = merged_lines  #2.5
...
saida_excel = "saida_final_ver.2.5.xlsx"
